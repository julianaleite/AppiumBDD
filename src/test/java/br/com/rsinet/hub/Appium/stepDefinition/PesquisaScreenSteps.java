...
public class PesquisaScreenSteps {
	...
	public void digitar_no_campo_de_pesquisa_um_produto_que_nao_existe() throws Throwable {
		pesquisa.EscreverNoCampoPesquisa("IphoneX");
		pesquisa.ClicarNAlupa();
	...
	public void entao_escolher_produto() throws Throwable {
		String tablets = driver.findElementById("com.Advantage.aShopping:id/textViewProductName").getText();
		Assert.assertTrue(tablets.contains("HP ELITE X2 1011 G1 TABLET"));
	 
	}

	@Entao("^entao produto nao  existe$")
	public void entao_produto_nao_existe() throws Throwable {
		String filters = driver.findElementById("com.Advantage.aShopping:id/textViewFilter").getText();
		Assert.assertTrue(filters.contains("FILTERS"));
