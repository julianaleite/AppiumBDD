...
public class TelaInicialScreenSteps {
	...
	public void produto_Escolhido() throws Throwable {
		String laptops = driver.findElementById("com.Advantage.aShopping:id/textViewProductName").getText();
		Assert.assertTrue(laptops.contains("HP ENVY - 17T TOUCH LAPTOP"));
...
//	}
	...
	public void efetuar_login_no_cadastro() throws Throwable {
		home.Name("juliana.silva@teste.com.br");
		home.Senha("1213Ju");
		home.Login();
	}
	...
	public void clicar_em_login() throws Throwable {
		String forgot = driver.findElementById("com.Advantage.aShopping:id/textViewForgetPassword").getText();
		Assert.assertTrue(forgot.contains("Forgot your password"));
